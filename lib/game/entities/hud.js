...
// ig.game.spawnEntity( EntityHudHelper, 20, 100, {textinput:"\tCovertness: ",} );
    ...
    ig.game.font.draw( 
        "Exp: "+" "+ig.game.virus.exp_cost, //useless piece of line segment to hold that comma
        19, 19);
    ig.game.font.draw( 
        "B / MB "+" "+ig.game.virus.bandwidth, //useless piece of line segment to hold that comma
        200, 19);
    ig.game.font.draw( 
    ...
    ig.game.font.draw( 
        ...
        20, 70);
    ig.game.font.draw( 
        "\tPortability "+" "+ig.game.virus.portability, //useless piece of line segment to hold that comma
        20, 80);
    ig.game.font.draw( 
        "\tInfectiousness "+" "+ig.game.virus.infectious, //useless piece of line segment to hold that comma
        20, 90);
    ig.game.font.draw( 
        "\tCovertness "+" "+ig.game.virus.covertness, //useless piece of line segment to hold that comma
        20, 100);
    // ig.game.font.draw( 
