...
.defines(function(){
  EntityUpgradeFiller = ig.Entity.extend({
      ...
      [             //nounlist is like an array, so we use square brackets
        {"name":"Web",
          "text":[ //text[] is like an array
              {"outcome":"Anon hacked",},
              {"outcome":"Terrorists planted",},
              {"outcome":"Ant-Christs bellowed",} //no comma cuz last thing in array
        ...
        {"name":"Server",
          "text":[ //text[] is like an array
              {"outcome":"Pedophiles captured",},
              {"outcome":"Demons stole",},
              {"outcome":"Thieves stole",} 
              ],
          "portability":5,
          "infectious":5,
          "covertness":5,
        ...
        {"name":"Command",
          "text":[ //text[] is like an array
              {"outcome":"Jihidists targeted",},
              {"outcome":"Convicted Felons stole",},
              {"outcome":"Vagrants raided",} 
              ],
          "portability":5,
          "infectious":5,
          "covertness":5,
         ...
         {"name":"Admin",
          "text":[ //text[] is like an array
              {"outcome":"Mobsters hacked",},
              {"outcome":"Gang Members got away with",},
              {"outcome":"Thieves carted away",} 
              ],
          "portability":5,
          "infectious":5,
          "covertness":5,
    ...
    [
      {"name":"Buster",
        "text":[ //text[] is like an array
            {"outcome":"a helpless orphanage!",},
            {"outcome":"innocent schoolchildren!",},
            {"outcome":"at-risk youth!",} 
            ],
        "portability":5,
        "infectious":5,
        "covertness":5,
      ...
      {"name":"Infection",
        "text":[ //text[] is like an array
            {"outcome":"schoolteachers savings!",},
            {"outcome":"field-trip money!",},
            {"outcome":"off-shore accounts!",} 
            ],
        "portability":5,
        "infectious":5,
        "covertness":5,
      ...
      {"name":"Stealth",
        "text":[ //text[] is like an array
            {"outcome":"your taxdollars!",},
            {"outcome":"the gasa strip!",},
            {"outcome":"our allies supplies!",} 
            ],
        "portability":5,
        "infectious":5,
        "covertness":5,
       ...
       {"name":"Override",
        "text":[ //text[] is like an array
            {"outcome":"national secrets!",},
            {"outcome":"consumer identities!",},
            {"outcome":"our economic stability!",} 
            ],
        "portability":5,
        "infectious":5,
        "covertness":5,
